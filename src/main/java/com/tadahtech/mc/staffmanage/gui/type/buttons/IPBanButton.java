...
public class IPBanButton extends MenuButton {
    private PunishmentData data;

    public IPBanButton(PunishmentData data) {
        super(new ItemBuilder(Material.BARRIER).setTitle(Colors.RED + Colors.UNDERLINE + Colors.BOLD + "IP Ban").build());
        this.data = data;
    }
